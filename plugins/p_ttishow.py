...
async def save_group(bot, message):
    ...
    if temp.ME in r_j_check:
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton("ʙᴏᴛ ᴏᴡɴᴇʀ", url="t.me/SHD_KHAN")
                  ]]
        reply_markup=InlineKeyboardMarkup(buttons)
...
async def leave_a_chat(bot, message):
    ...
    try:
        buttons = [[
            InlineKeyboardButton('sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ',url="https://t.me/SHD_MoviesSearchGroup"),
            InlineKeyboardButton('ᴏᴡɴᴇʀ', url="t.me/SHD_KHAN")
        ],[
