...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        if AUTH_CHANNEL and not await is_subscribed(client, query):
            await query.answer("ᴅᴏɴ'ᴛ ʙᴇ ᴏᴠᴇʀsᴍᴀʀᴛ ! Jᴏɪɴ ғɪʀsᴛ😒", show_alert=True)
            return
        ...
        btn2 = [[
                 ...
                 InlineKeyboardButton("Rᴇᴏ̨ᴜᴇsᴛ Gʀᴏᴜᴘ Lɪɴᴋ", url="https://telegram.me/SHD_MoviesSearchGroup")
               ]]
        if query.from_user.id in ADMINS:
            user = await client.get_users(from_user)
            reply_markup = InlineKeyboardMarkup(btn)
    ...
    # don't change anything without contacting me @LazyDeveloperr
        ...
        buttons = [[
                    ...
                    InlineKeyboardButton('ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ', url="https://t.me/SHD_MoviesSearchGroup")
                ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    if not spoll:
        ...
        reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(f'Seaching for {search} 🔎', url=f"https://t.me/Anime_Hindi_Series")]]) 
                                         )
            search = search.lower()
            find = search.split(" ")
            search = ""
